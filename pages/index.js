      ...
      <BaseLayout>
            ...
            <div className="row banner-content">
              <div className="col banner-left-content">
                <img
                  ...
                  alt="Desenho de crianças estudando"
                  width="800px"
                  height="561px"
                />
              </div>
              ...
              <div className="col banner-right-content">
                <h2>
                  Os melhores jogos <br />e atividades para <br />
                  aprender brincando!
                </h2>
                    ...
                    <div className="play-button">
                      <div>
                        ...
                        <div className="search-bar-itens shadow-lg play-card play-card-outer">
                          <button className="btn search-input form-input-font btn-font-orange play-card">
                            Iniciar
                          </button>
                        </div>
                      </div>
        ...
        <section className="atividades">
          <div className="section-head">
            ...
            <span className="section-text">
              Veja o que oferecemos para auxiliar o seu aprendizado!
            </span>
          </div>
          <div className="row">
            <div className="col atividades-content">
              ...
              <span className="section-text">
                Divirta-se e aprenda com jogos como quebra-cabeça, bingo e
                diversos outros disponíveis!
              </span>
            </div>
            <div className="col atividades-content">
              ...
              <span className="section-text">
                Resolva atividades desafiadoras, crie gibis e jornais e teste
                seus conhecimentos!
              </span>
            </div>
            <div className="col atividades-content">
              ...
              <span className="section-text">
                Jogue ou faça as atividades escritas e editadas pelo seu
                professor!
              </span>
            </div>
          </div>
        ...
        <section className="news full-width">
          <div className="container">
            <div className="section-head">
              <h4 className="subtitle white-header">
                Receba nossas novidades!
              </h4>
              <span className="newsletter-call">
                Envie seu e-mail para ficar por dentro de tudo!
              </span>
            </div>
            ...
            <div className="row form">
              ...
              <div className="search-bar-itens search-input-container search-input-container-large shadow-sm">
                <input
                  className="search-input search-input-large form-input-font"
                  type="text"
                  name="search"
